...
/**
 * Parser for the {@code <context:excel-scan/>} element.
 *
 * @author Mark Fisher
 ...
 * @since 2.5
 */
public class ExcelScanBeanDefinitionParser implements BeanDefinitionParser {
        ...
        if (element.hasAttribute(SCOPE_RESOLVER_ATTRIBUTE)) {
            if (element.hasAttribute(SCOPED_PROXY_ATTRIBUTE)) {
                throw new IllegalArgumentException(
                        "Cannot define both 'scope-resolver' and 'scoped-proxy' on <excel-scan> tag");
            }
